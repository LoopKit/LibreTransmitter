...
public final class Features {
    ...
    // Uses Vibration through apples audio ap for glucose alarmsi. This could be considered an api abuse from apple's standpoint;
    ...
    // * For heavy sleepers, the combination of an alarm at 100% voume vibration makes it much more likely to wake up during nighttime.
